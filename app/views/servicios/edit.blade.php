@extends('header')
@section('title')Editar Servicio @stop
  @section('head') @stop
@section('encabezado')  SERVICIOS @stop
@section('encabezado_descripcion') Editar Servicio {{$product->notes}} @stop
@section('nivel') <li><a href="{{URL::to('productos')}}"><i class="fa fa-cube"></i>Servicios</a></li><li><i class="glyphicon glyphicon-briefcase"></i>Servicios</li>
...
<div class="box">
  ...
  <div class="box-body">
		...
		{{ Former::open(productos)->addClass('col-md-12 warn-on-exit')->method($method)->rules(array(
