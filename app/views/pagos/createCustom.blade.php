		...
		<div class="row">
			<div class="col-md-10">			
                                <div class="form-group">
                                    <label class="control-label col-lg-2 col-sm-4" for="client_id">
                                        Cliente<sup>*</sup>
                                    </label><div class="col-lg-10 col-sm-8">
                                        {{$cliente}}
                                        </div></div>
                            <div class="form-group">
                                    <label class="control-label col-lg-2 col-sm-4" for="invoice_id">
                                        Factura<sup>*</sup>
                                    </label><div class="col-lg-10 col-sm-8">
                                        {{$factura}}
                                        </div></div>				
				{{ Former::text('amount')->label('Monto')->title('Solo se acepta números.')->value($amount)->id('amount')}}
				...
				{{ Former::text('transaction_reference')->label('Referencia de Pago')->placeholder('Pago realizado') }}
                                <input id="client_id" type="hidden" name="client" value="{{$client_id}}">
                                <input id="invoice_select" type="hidden" name="invoice" value="{{$invoice_id}}">
